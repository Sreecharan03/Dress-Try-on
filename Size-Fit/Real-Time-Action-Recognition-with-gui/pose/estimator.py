...
#                print("3D coordinates of the point"+str(body_part.part_idx)+"are",func(center[0],center[1]))
            ...
            for val in Values:
                if val[0]==2:
                    ...
                    Rshoulder=func(val[1],val[2])
                    
                if val[0]==5:
                    Lshoulder=func(val[1],val[2])
                
                if val[0]==8:
                    Rhip=func(val[1],val[2])
                if val[0]== 11:
                    Lhip=func(val[1],val[2])
                if val[0]==3:
                    Relbow=func(val[1],val[2])
                if val[0]==4:
                    Rwrist=func(val[1],val[2])
                if val[0]==10:
                    Rankle=func(val[1],val[2])
